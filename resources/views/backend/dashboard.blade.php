                        ...
                        <div class="d-block d-md-flex justify-content-between">
                            ...
                            <div class="d-block d-md-flex nav-tabs-custom">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active show" id="months-tab" data-bs-toggle="tab" href="#months" role="tab" aria-controls="months" aria-selected="true"> Months</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="year-tab" data-bs-toggle="tab" href="#year" role="tab" aria-controls="year" aria-selected="false">Year </a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-20">
                            <div class="d-flex">
                                ...
                                <div class="ms-3 w-100">
                                    <h6 class="mt-0 mb-0">Car dealer <span class="float-end text-danger"> 8,561</span>  </h6>
                        ...
                        <li class="mb-20">
                            <div class="d-flex">
                                ...
                                <div class="ms-3 w-100">
                                    <h6 class="mt-0 mb-0">Webster <span class="float-end text-warning"> 6,213</span>  </h6>
                        ...
                        <li class="mb-20">
                            <div class="d-flex">
                                ...
                                <div class="ms-3 w-100">
                                    <h6 class="mt-0 mb-0">The corps  <span class="float-end text-success"> 2,926</span>  </h6>
                        ...
                        <li>
                            <div class="d-flex">
                                ...
                                <div class="ms-3 w-100">
                                    <h6 class="mt-0 mb-0">Sam martin <span class="float-end text-warning">6,213 </span></h6>
        ...
        <div class="col-xl-4 mb-20">
            <div class="card card-statistics h-100">
                <div class="p-4 text-center bg" style="background: url(images/bg/01.jpg);">
                    ...
                    <div class="btn-group info-drop">
                        <button type="button" class="dropdown-toggle-split text-white" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="ti-more"></i></button>
                        <div class="dropdown-menu">
    ...
    <div class="calendar-main mb-20">
        <div class="row">
            <div class="col-lg-3">
                <div class="row">
                    <div class="col-12">
                        <a href="#" data-bs-toggle="modal" data-bs-target="#add-category" class="btn btn-primary w-100 py-2">
                                ...
                                <form>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-control form-white" data-bs-placeholder="Choose a color..." name="category-color">
